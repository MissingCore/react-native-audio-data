...
namespace margelo::nitro::audiodata {
  ...
  public:
    ...
    std::shared_ptr<Promise<std::vector<double>>> getWaveformData(const std::string& path, double millisecondsPerPoint, std::optional<WaveformMethod> method) override;
  };
