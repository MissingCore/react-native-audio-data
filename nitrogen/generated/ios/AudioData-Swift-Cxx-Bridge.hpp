///
/// AudioData-Swift-Cxx-Bridge.hpp
...
namespace margelo::nitro::audiodata::bridge::swift {
  ...
  /**
   * Specialized version of `std::shared_ptr<HybridFileHelperSpec>`.
   */
  using std__shared_ptr_HybridFileHelperSpec_ = std::shared_ptr<HybridFileHelperSpec>;
  ...
  // pragma MARK: std::weak_ptr<HybridFileHelperSpec>
  using std__weak_ptr_HybridFileHelperSpec_ = std::weak_ptr<HybridFileHelperSpec>;
  inline std__weak_ptr_HybridFileHelperSpec_ weakify_std__shared_ptr_HybridFileHelperSpec_(const std::shared_ptr<HybridFileHelperSpec>& strong) noexcept { return strong; }
